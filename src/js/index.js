...
// OBJETIVO 1 - quando passar o mouse em cima do personagem na listagem, devemos selecioná-lo
       ...
       // passo 3 - verificar se já existe um personagem selecionado, se sim, devemos remover a se leção dele
...
function alteraNomePersonagemSelecionado(personagem) {
    const nomePersongaem = document.getElementById('nome-personagem');

    nomePersongaem.innerText = personagem.getAttribute('data-name');
}
